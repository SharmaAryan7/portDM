...
export function Certificates() {
    return (
        <section id="certificates" className="py-24 bg-gradient-to-b from-slate-900 to-slate-950 text-white">
                    ...
                    {certificatesData.map((cert, index) => {
                        ...
                        return (
                            <motion.div
                                ...
                                className="group"
                            >
                                <Card className="h-full border-slate-800 bg-slate-900/50 overflow-hidden relative border hover:border-purple-500/50 cursor-pointer">
